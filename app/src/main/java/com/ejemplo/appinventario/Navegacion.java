...
import com.ejemplo.appinventario.Vistas.VistaBaseDatos;
import com.ejemplo.appinventario.Vistas.VistaCotizaciones;
import com.ejemplo.appinventario.Vistas.VistaProductos;
import com.ejemplo.appinventario.Vistas.VistaProveedores;
import com.ejemplo.appinventario.Vistas.VistaReportes;
import com.ejemplo.appinventario.Vistas.VistaVentas;

public class Navegacion extends AppCompatActivity {

    CardView cvProveedores, cvProductos, cvCotizaciones, cvVentas, cvReportes, cvBaseDatos;
    ImageButton ibtnContacto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvBaseDatos = findViewById(R.id.cvBaseDatos);
        ...
        ibtnContacto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String[] TO = {"andrescede20@gmail.com"}; //aquí pon tu correo
                String[] CC = {""};
